...
У зв'язку з обмеженнями GitHub, самі книги зберігаються на Google Drive
...
[
  {
    ...
    "file": "1a2b3c4d5e6f",
    "cover": "cover/Khorova_zbirka_dlia_ditei.png",
    "short_url": "https://tinyurl.com/2b3c4d5",
    "size_mb": 12.5,
...
- На мобільних пристроях категорії та алфавітні кнопки приховані під спойлером “Фільтри”.
